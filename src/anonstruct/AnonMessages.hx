...
class AnonMessages {
    ...
    static public function setLanguage_PT_BR() {
        NULL_VALUE_NOT_ALLOWED = "Valor não pode ser nulo.";
        DATE_VALUE_INVALID = "O valor deve ser uma data válida.";
        DATE_VALUE_MUST_BE_BEFORE = "Valor deve ser anterior a ?VALUE0.";
        DATE_VALUE_MUST_BE_BEFORE_OR_EQUAL = "Valor deve ser anterior ou igual a ?VALUE0.";
        DATE_VALUE_MUST_BE_AFTER = "Valor deve ser posterior a ?VALUE0.";
        DATE_VALUE_MUST_BE_AFTER_OR_EQUAL = "Valor deve ser posterior ou igual a ?VALUE0.";
        ARRAY_VALUE_INVALID = "O valor esperado deve ser um array.";
        ARRAY_VALUE_MIN_ITEM_SINGLE = "O valor deve ter pelo menos 1 item.";
        ARRAY_VALUE_MIN_ITEM_PLURAL = "O valor deve ter pelo menos ?VALUE0 itens.";
        ARRAY_VALUE_MAX_ITEM_SINGLE = "O valor deve ter no máximo 1 item.";
        ARRAY_VALUE_MAX_ITEM_PLURAL = "O valor deve ter no máximo ?VALUE0 itens.";
        STRING_VALUE_INVALID = "O valor deve ser um texto.";
        STRING_VALUE_CANNOT_BE_EMPTY = "Valor não pode ser vazio.";
        STRING_VALUE_MIN_CHAR_SINGLE = "O valor deve ter pelo menos 1 caractere.";
        STRING_VALUE_MIN_CHAR_PLURAL = "O valor deve ter pelo menos ?VALUE0 caracteres.";
        STRING_VALUE_MAX_CHAR_SINGLE = "O valor deve ter no máximo 1 caractere.";
        STRING_VALUE_MAX_CHAR_PLURAL = "O valor deve ter no máximo ?VALUE0 caracteres.";
        STRING_VALUE_SHOULD_STARTS_WITH = "O valor deve ser iniciado com ?VALUE0.";
        STRING_VALUE_SHOULD_ENDS_WITH = "O valor deve terminar em ?VALUE0.";
        STRING_VALUE_CHAR_NOT_ALLOWED = "O caractere ?VALUE0 não é permitido.";
        STRING_VALUE_OPTION_NOT_ALLOWED = "O valor ?VALUE0 não é permitido. Os valores aceitos são: ?VALUE1.";
